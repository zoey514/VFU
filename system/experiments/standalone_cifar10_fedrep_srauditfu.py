...
def main() -> None:
    ...
    if args.enable_zk_mcr:
        ...
        proof = verifier.prove(
            theta_before=pre_shared_state,
            target_contribution=target_contribution,
            mask=mask,
            masked_contribution=masked_contribution,
            theta_after=mcr_shared_state,
            mcr_strength=audit_cfg.mcr_strength,
        ...
        zk_mcr_metadata = {
            ...
            "proves_contribution_consistency": bool(verification["levels"]["contribution_consistency"]["available"]),
            "proves_mask_generation_correctness": False,
            "proves_merkle_inclusion": False,
            "production_zksnark": False,
            "relation_levels": proof.relation_levels,
